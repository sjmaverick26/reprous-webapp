...
- **No Destructive Operations**: Never run destructive commands (e.g., `git reset --hard`, `git clean -fd`, deleting branches, dropping database tables, or removing critical files) without explicit user confirmation.
