...
const DEFAULT_REFERENCES: Record<string, ReferenceItem[]> = {
  ...
  factors: [
    ...
    },
    {
      number: "02",
      type: "Research article",
      title: "A Century of Sex-Bias in Biomedical Research: How Male Models Impact Female Health",
      source: "Nature / Biology of Sex Differences (Zucker & Prendergast)",
      url: "https://bsd.biomedcentral.com/articles/10.1186/s13293-020-00308-5",
      linkText: "Read Nature Study",
    },
    {
      number: "03",
      type: "Patient education resource",
    ...
    },
    {
      number: "04",
      type: "Research article",
      title: "Gender Disparities in Analgesic Administration: The Pain Assessment and Treatment Gap",
      source: "Academic Emergency Medicine",
      url: "https://onlinelibrary.wiley.com/doi/10.1111/j.1553-2712.2008.00100.x",
      linkText: "View ER Pain Study",
    },
  ],
  advocacy: [
    {
      ...
      source: "Nature / Biology of Sex Differences (Zucker & Prendergast)",
      url: "https://bsd.biomedcentral.com/articles/10.1186/s13293-020-00308-5",
      linkText: "Read Nature Research",
    },
    {
      number: "02",
      type: "Research article",
      title: "Gender Disparity in Analgesic Administration: How Women Wait Longer for Pain Relief",
      source: "Academic Emergency Medicine (Chen et al.)",
      url: "https://onlinelibrary.wiley.com/doi/10.1111/j.1553-2712.2008.00100.x",
      linkText: "View Pain Study",
    },
    {
      number: "03",
      type: "Clinical guideline",
      title: "Policy on Sex as a Biological Variable (SABV) & Female Trial Inclusion",
      source: "National Institutes of Health (NIH) Office of Research on Women's Health (ORWH)",
      url: "https://orwh.od.nih.gov/sex-gender/nih-policy-sex-biological-variable",
      linkText: "Read NIH Policy",
    },
    {
      number: "04",
      type: "Clinical guideline",
      title: "Sex-Specific Dosage Requirements & Women's Adverse Drug Reaction Disparities",
      source: "U.S. Food and Drug Administration (FDA) Office of Women's Health",
      url: "https://www.fda.gov/consumers/womens-health",
      linkText: "Read FDA Guideline",
    },
    {
      number: "05",
      type: "Research article",
      title: "Advancing the Science of Women's Health & Eliminating Evidence Gaps",
      source: "The Lancet Series on Gender Equality and Health",
      url: "https://www.thelancet.com/series/gender-equality-norms-health",
      linkText: "View Lancet Series",
    },
  ],
};
